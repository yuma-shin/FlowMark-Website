...
> [!CAUTION] Warning
> Deleting a folder will permanently delete all notes inside it as well. Make sure it does not contain any important notes before deleting.
> Also, the root folder cannot be deleted.
